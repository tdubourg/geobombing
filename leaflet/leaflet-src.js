...
L.TileLayer = L.Class.extend({
	...
	_addTilesFromCenterOut: function (bounds) {
		console.log("_addTilesFromCenterOut", bounds)
		
		this.exported_bounds = bounds // @td

		var queue = [],
		    center = bounds.getCenter();
		
		console.log("_addTilesFromCenterOut", center)
		var j, i, point;
	...
	_addTile: function (tilePoint, container) {
		console.log("tilePoint heh?", tilePoint)
