...
FORCETRANSMIT_RADIUS = 0.001

ACCEPTABLE_POS_DELTA_FOR_STANDING_STILL_OUTSIDE_PREDICTION = 0.0001
ACCEPTABLE_POS_DELTA_FOR_STANDING_STILL_DURING_PREDICTION = 0.0001
...
-- GAMEPLAY
PLAYER_MOVE_ON_DRAG_UPDATE_INTERVAL_IN_MS = 170
